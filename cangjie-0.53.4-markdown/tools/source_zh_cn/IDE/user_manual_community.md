...
![setupVsix](figures/setupVsix.png)


已经安装的插件可以在 INSTALLED 目录下查看


![checkVsix](figures/checkVsix.png)
...
![WindowsSDK](figures/WindowsSDK.png)
...
![CJNativeSdkPathSet](figures/llvmSdkPathSetCommunity.png)
...
![commandNoSdk](figures/commandNoSdk.png)
...
![buttonOnlyInstall](figures/buttonOnlyInstall.png)
2. 在弹出的窗口中选择下载和安装路径（注意路径不能存在名为 `cangjie` 的文件夹）并单击 "Choose the SDK install path" 确定。


![buttomInstall](figures/buttomInstall.png)
3. 完成路径选择后，仓颉 SDK 开始下载：


![onInstall](figures/onInstall.png)
4. 下载完成后，会自动配置仓颉 SDK 的安装路径。


![installDone](figures/installDone.png)
...
![typeHierarchy](figures/typeHierarchy3.png)
...
![callHierarchy](figures/callHierarchy3.png)
...
![createProject_7](figures/createProject_7_community.png)
...
![createProject_5](figures/createProject_5.png)
...
![createProjectView_3](figures/createProjectView_3.png)
...
![aliasHello](figures/aliasHello.png)
...
![buildTarget](figures/buildTarget.png)


如果叠加参数中选择了`cjpm build --<customized-option>`,那么用户可以选择透传参数


![addOption.png](figures/addOption.png)
...
![showTogether](figures/showTogether.png)


对于构建参数`cross-compile-configuration`,可以通过点击`Add Configuration` 按钮添加选项


![addConfiguration](figures/addConfiguration.png)
...
![addrequire](figures/addrequire.png)


也可以通过点击三方库上的减号删除对应的库


![deleLib](figures/deleLib.png)
...
* attach 模式调试本地进程
	...
	![attachSelectProcess](figures/attachSelectProcess.png)
* attach 模式调试远程进程
...
![debugControl2.png](figures/debugControl2.png)
...
![debugTimelineOperation.png](figures/debugTimelineOperation.png)
...
![cjcovResult](figures/cjcovResult.png)
